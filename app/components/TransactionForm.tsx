...
export default function TransactionForm({ onSubmit, currencySymbol }: TransactionFormProps) {
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 pl-8 pr-4 py-2.5 text-gray-900 dark:text-gray-100 focus:border-blue-500 focus:ring-blue-500"
            placeholder="0.00"
          />
        </div>
      </div>
